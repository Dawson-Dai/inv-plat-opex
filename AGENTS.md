...
Uses the `opex-confluence-publish` skill (`.Codex/skills/opex-confluence-publish/SKILL.md`). Publishes to the `~dawsondai` personal space (parent page ID `2047672627`) for review, then manually moved to the IP space.
...
All three skills are checked into `.Codex/skills/` and load automatically:
